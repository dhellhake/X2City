...
COMPILER_ALIGNED(4)
static CanMramSidfe can1_rx_standard_filter;
COMPILER_ALIGNED(4)
static CanMramRxbe  can1_rx_buffer;
COMPILER_ALIGNED(4)
static CanMramTxbe  can1_tx_buffer;
COMPILER_ALIGNED(4)
static CanMramTxefe can1_tx_event_fifo;
...
void can0_transmit(uint16_t address, uint8_t size, uint8_t* data)
{
	...
	can0_tx_buffer.TXBE_0.reg =		CAN_TXBE_0_ID(address << 18);			// Message ID
	
	can0_tx_buffer.TXBE_1.reg =		CAN_TXBE_1_DLC(15);							// Data Lenght Code (64 bytes)
